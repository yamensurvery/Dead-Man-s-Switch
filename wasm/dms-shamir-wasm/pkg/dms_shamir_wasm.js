/* @ts-self-types="./dms_shamir_wasm.d.ts" */
 ...
 * @returns {string[]}
 */
export function split_key(key_bytes, threshold, total) {
    const ptr0 = passArray8ToWasm0(key_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.split_key(ptr0, len0, threshold, total);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('dms_shamir_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
